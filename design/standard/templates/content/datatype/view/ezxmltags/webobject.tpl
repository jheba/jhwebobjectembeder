...
<div class="webobject-container">
    {include uri=concat("design:content/datatype/view/ezxmltags/webobject_", $webobjectdata.platform|downcase(), ".tpl") webobject_id=$webobjectdata.id dimension=$webobjectdata.dimension caption=$caption}
</div>
{/if}
